...
SynthDef(\warp, {arg buffer = 0, envbuf = -1, pan = 0, begin=0, end=1, period, duration;
	var output_front, output_center, output_rear, pointer, filelength, pitch, env_front, env_center, env_rear, dir, pan_env;
	...
	output_center = Pan2.ar(env_center * Warp1.ar(1, buffer, pointer, pitch, 0.1, -1, 8, 0.1, 2), pan_env);
